...
#pragma warning restore 0414
		...
		private void RefreshDriveQuickLinks()
		{
			...
			Debug.Log("GetExternalDrives" + drivesList);
...
#if !UNITY_EDITOR && UNITY_ANDROID
		public void ShowDirectSAF() {
			Debug.Log("ShowDirectSAF");
            FileBrowserHelpers.AJC.CallStatic("PickSAFFolder", FileBrowserHelpers.Context, new FBDirectoryReceiveCallbackAndroid(OnSAFDirectoryDirectlyPicked));
			Debug.Log("End ShowDirectSAF");
        }
#endif
...
#if !UNITY_EDITOR && UNITY_ANDROID
		private void OnSAFDirectoryDirectlyPicked( string rawUri, string name )
		{
			Debug.Log("OnSAFDirectoryDirectlyPicked");
        ...
        public static void DirectNativeSAF()
        {

#if !UNITY_EDITOR && UNITY_ANDROID
			Instance.ShowDirectSAF();		
#endif
        }
        ...
        {
            return Instance.CurrentPathName;
        }
