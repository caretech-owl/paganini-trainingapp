...
public class Pathpoint
{
	...
	{
		return string.Format("[pathpoint: ppoint_id={0}, erw_id={1}, ppoint_lon={2},  ppoint_lat={3},  ppoint_altitude={4},  ppoint_accuracy={5},  ppoint_poitype={6}, ppoint_timestamp={7},  ppoint_description={8}]", Id,Erw_id,Longitude,Latitude,Altitude,Accuracy,POIType, Timestamp,Description);
	}
