...
/// Implemented by Patryk Galach
/// https://www.patrykgalach.com/2019/04/04/singleton-in-unity-love-or-hate/
/// </summary>
public class SessionData : PersistentLazySingleton<SessionData>
{
    ...
    public void SaveData(string key, object data)
    {
        ...
        {
            Debug.LogWarningFormat("[{0}] Overriding value in: {1}.", typeof(SessionData), key);
        }
    ...
    public T GetData<T>(string key)
    {
        ...
        {
            Debug.LogWarningFormat("[{0}] No value under key: {1}. Returning default", typeof(SessionData), key);
